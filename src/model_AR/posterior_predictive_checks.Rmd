...
plot(density(rbeta(1000, 1, 1)), xlim = c(0, 1), main = "Prior: Mu Rho")
plot(density(runif(1000, 10, 100)), xlim = c(10, 100), main = "Prior: Sigma Rho")
```
...
rm(samples, i)
samples_ls <- list("sampARC" = sampC, "sampARS" = sampS, "sampARSh" = sampSh)
...
lines(density(sampARC$BUGSoutput$sims.list$mu_rho - (sampARC$BUGSoutput$sims.list$delta_rho/2)), 
      col = colors[3])
legend("topleft", fill = colors, legend = mpd_c)
...
lines(density(sampARS$BUGSoutput$sims.list$mu_rho - (sampARS$BUGSoutput$sims.list$delta_rho/2)), 
      col = colors[3])
legend("topleft", fill = colors, legend = mpd_s)
...
lines(density(sampARSh$BUGSoutput$sims.list$mu_rho - (sampARSh$BUGSoutput$sims.list$delta_rho/2)), 
      col = colors[3])
legend("topleft", fill = colors, legend = mpd_sh)
